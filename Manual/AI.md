...
The Conditions Data are kept in Oracle database at CERN. Programs that need the access to the Conditions Data are running 24/7 at a number of geographically distributed computing centers (usually referred as "sites").
...
* instance - identifier distinguishing servers at the same site
...
All the varnishes send most of the details usually found in varnihstat reports to an Elasticsearch index at University of Chicago. To get realtime or historical data from that index, you can ask the question to an agent running at ...
